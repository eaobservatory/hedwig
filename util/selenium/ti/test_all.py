...
class IntegrationTest(DummyConfigTestCase):
    def test_app(self):
        ...
        try:
            ...
            proposal_code = self.create_proposal('jcmt', semester_name)

            self.view_proposal_by_code('jcmt', proposal_code)
            ...
            # Remove group invitations so that we can invite an external
            # reviewer and have that be the only active invitation.
            ...
            # Change institution of "Another Person" so that they appear
            # as a "frozen member" of "Test Institution".
            self.log_in_user(user_name='username2')

            self.change_institution(
    ...
    def register_user(
        ...
        self.browser.find_element(By.NAME, 'person_name').send_keys(person_name)

        if public_profile:
            self.browser.find_element(By.NAME, 'person_public').click()

        self.browser.find_element(By.NAME, 'single_email').send_keys(
            person_email)
    ...
    def _do_verify_email(self, email_address, screenshot_path=None):
        ...
        if screenshot_path is not None:
            # Do this test only once - when we are registering the first
            # user account and acquiring screenshots.
            self._save_screenshot(screenshot_path, 'email_verify_get')

            self.browser.find_element(By.LINK_TEXT, 'edit your address').click()
            self.assertIn(
        ...
        self.browser.find_element(By.NAME, 'submit_send').click()
        ...
        self.browser.find_element(By.NAME, 'token').send_keys(token)
    ...
    def _do_register_user(self, user_name, password, screenshot_path=None):
        self.browser.find_element(By.NAME, 'user_name').send_keys(user_name)
        self.browser.find_element(By.NAME, 'password').send_keys(password)
        self.browser.find_element(By.NAME, 'password_check').send_keys(password)
    ...
    def set_up_facility(self, facility_code):
        ...
        self.browser.find_element(By.NAME, 'queue_name').send_keys(queue_name)
        self.browser.find_element(By.NAME, 'queue_code').send_keys('P')
        ...
        affiliation_add = self.browser.find_element(By.ID, 'add_affiliation')
        affiliation_add.click()
        affiliation_add.click()
        affiliation_add.click()

        self.browser.find_element(By.NAME, 'name_new_1').send_keys('China')
        self.browser.find_element(By.NAME, 'name_new_2').send_keys('Japan')
        self.browser.find_element(By.NAME, 'name_new_3').send_keys('Other')
        Select(
        ...
        # Add categories.
        self.browser.get(admin_menu_url)
        self.browser.find_element(By.LINK_TEXT, 'Categories').click()

        category_add = self.browser.find_element(By.ID, 'add_category')
        category_add.click()
        category_add.click()

        self.browser.find_element(By.NAME, 'name_new_1').send_keys(
            'Star formation')
        ...
        self.browser.find_element(By.LINK_TEXT, 'View all defined areas of sky coverage').click()

        self.browser.find_element(By.LINK_TEXT, 'New coverage map').click()

        self.browser.find_element(By.NAME, 'name').send_keys('Example')
        self.browser.find_element(By.NAME, 'description').send_keys(
            'This area is part of the "..." survey and ...')

        # Give path to MOC assuming we are in the top level directory.
        self.browser.find_element(By.NAME, 'file').send_keys(
    ...
    def _create_semester(self, suffix, screenshot_path=None):
        self.browser.find_element(By.LINK_TEXT, 'Semesters').click()
        self.browser.find_element(By.LINK_TEXT, 'New semester').click()
        ...
        self.browser.find_element(By.NAME, 'semester_name').send_keys(
            semester_name)
        self.browser.find_element(By.NAME, 'semester_code').send_keys(
            semester_name)
        self.browser.find_element(By.NAME, 'start_date').send_keys(
            semester_year + '-01-01')
        self.browser.find_element(By.NAME, 'start_time').send_keys(
            '00:00')
        self.browser.find_element(By.NAME, 'end_date').send_keys(
            semester_year + '-07-01')
        self.browser.find_element(By.NAME, 'end_time').send_keys(
            '00:00')
        self.browser.find_element(By.NAME, 'description').send_keys(
        ...
        preamble_link = self.browser.find_element(By.ID, 'preamble_edit_1')
        self._save_screenshot(
    ...
    def _create_call(
        ...
        self.browser.find_element(By.LINK_TEXT, type_name).click()
        ...
        self.browser.find_element(By.NAME, 'open_date').send_keys(
            current_year + '-01-01')
        self.browser.find_element(By.NAME, 'open_time').send_keys(
            '00:00')
        self.browser.find_element(By.NAME, 'close_date').send_keys(
            current_year + '-12-31')
    ...
    def create_proposal(self, facility_code, semester_name):
        ...
        queue_link = self.browser.find_element(
            By.LINK_TEXT, 'Create a proposal for the PI Science Queue')
        ...
        self.browser.find_element(By.NAME, 'proposal_title').send_keys(
            'An Example Proposal')

        self._save_screenshot(self.user_image_root, 'proposal_new')

        self.browser.find_element(By.NAME, 'submit_new').click()
        ...
        identifier_cell = self.browser.find_element(
            By.ID, 'proposal_identifier_cell')

        identifier = identifier_cell.text
        ...
        Select(
            self.browser.find_elements(By.NAME, 'affiliation_id')[0]
        ...
        self.browser.find_element(By.LINK_TEXT, 'Edit student list').click()

        self.browser.find_element(By.NAME, 'student_2').click()
        ...
        for affiliation_selection in self.browser.find_elements(
                By.NAME, 'affiliation_id'):
            Select(affiliation_selection).select_by_visible_text('Other')

        self.browser.find_element(By.NAME, 'name').send_keys('Invited Member')
        self.browser.find_element(By.NAME, 'email').send_keys(
            'invitee@somewhere.edu')

        self.browser.find_element(By.NAME, 'submit_invite').click()
        ...
        self.browser.find_element(By.LINK_TEXT, 'Re-send invitation').click()
        ...
        self.browser.find_element(By.LINK_TEXT, 'Submit proposal').click()
        ...
        with self.assertRaises(NoSuchElementException):
            self.browser.find_element(By.NAME, 'submit_confirm')
        ...
        self.browser.find_element(By.LINK_TEXT, 'Edit title').click()
        ...
        self.browser.find_element(By.PARTIAL_LINK_TEXT, 'Edit abstract').click()

        self.browser.find_element(By.NAME, 'category_1').click()
        ...
        self.browser.find_element(
            By.LINK_TEXT, 'Edit observing request').click()

        self.browser.find_element(By.ID, 'add_request').click()
        ...
        Select(
            self.browser.find_element(By.NAME, 'weather_new_1')
        ).select_by_value('1')
        Select(
            self.browser.find_element(By.NAME, 'weather_new_2')
        ).select_by_value('5')

        self.browser.find_element(By.NAME, 'time_new_1').send_keys(4)

        self.browser.find_element(By.NAME, 'time_new_2').send_keys(12)

        self._save_screenshot(self.user_image_root, 'request_edit')

        self.browser.find_element(By.NAME, 'submit_save').click()
        ...
        self.browser.find_element(
            By.PARTIAL_LINK_TEXT, 'Edit previous proposals').click()

        self.browser.find_element(By.NAME, 'code_new_1').send_keys('M00AI000')

        Select(
            self.browser.find_element(By.NAME, 'pub_type_0_new_1')
        ).select_by_visible_text('ADS bibcode')
        self.browser.find_element(By.NAME, 'publication_0_new_1').send_keys(
            '2013MNRAS.430.2513H')

        Select(
            self.browser.find_element(By.NAME, 'pub_type_1_new_1')
        ).select_by_visible_text('ADS bibcode')
        self.browser.find_element(By.NAME, 'publication_1_new_1').send_keys(
            '2013MNRAS.430.2534D')
        ...
        # Add target objects.
        self.browser.find_element(By.LINK_TEXT, 'Edit targets').click()

        self.browser.find_element(By.ID, 'add_target').click()
        ...
        self.browser.find_element(By.NAME, 'name_new_1').send_keys('LDN 123')
        self.browser.find_element(By.NAME, 'name_new_2').send_keys('LDN 456')
        self.browser.find_element(By.ID, 'resolve_new_1').click()
        self.browser.find_element(By.ID, 'resolve_new_2').click()
        self.browser.find_element(By.NAME, 'time_new_1').send_keys('8')
        self.browser.find_element(By.NAME, 'time_new_2').send_keys('8')
        self.browser.find_element(By.NAME, 'priority_new_1').send_keys('1')
        self.browser.find_element(By.NAME, 'priority_new_2').send_keys('2')
        ...
        self.assertTrue(self.browser.find_element(
            By.NAME, 'x_new_1').get_attribute('value').startswith('18:07:'))
        self.assertTrue(self.browser.find_element(
            By.NAME, 'y_new_1').get_attribute('value').startswith('-27:25:'))
        self.assertTrue(self.browser.find_element(
            By.NAME, 'x_new_2').get_attribute('value').startswith('18:52:'))
        self.assertTrue(self.browser.find_element(
            By.NAME, 'y_new_2').get_attribute('value').startswith('-10:55:'))
        ...
        self.browser.find_element(By.LINK_TEXT, 'Upload target list').click()
        ...
        self.browser.find_element(By.LINK_TEXT, 'Target Availability').click()

        self._save_screenshot(self.user_image_root, 'target_avail')

        self.browser.find_element(By.LINK_TEXT, 'Back to proposal').click()

        self.browser.find_element(By.LINK_TEXT, 'Edit note').click()
        ...
        self.browser.find_element(
            By.LINK_TEXT, 'Edit technical justification').click()

        edit_text_link = self.browser.find_element(By.LINK_TEXT, 'Edit text')
        ...
        self.browser.find_element(
            By.LINK_TEXT, 'Edit scientific justification').click()
        ...
        self.browser.find_element(By.LINK_TEXT, 'Validate proposal').click()
    ...
    def _add_figure(
        ...
        self.browser.find_element(By.LINK_TEXT, 'Upload new figure').click()
        ...
        self.browser.find_element(By.LINK_TEXT, 'Edit figure').click()
    ...
    def _add_itc_calculation(
        ...
        self.browser.find_element(By.LINK_TEXT, 'SCUBA-2 ITC').click()

        position = self.browser.find_element(By.NAME, 'pos')
        position.clear()
        position.send_keys('-10')

        rms = self.browser.find_element(By.NAME, 'rms')
        rms.clear()
        rms.send_keys(sensitivity)

        self.browser.find_element(By.NAME, 'submit_calc').click()
        ...
        self.browser.find_element(
            By.NAME, '{}calculation_title'.format(save_prefix)).send_keys(title)

        submit_save_redir = self.browser.find_element(
            By.NAME, '{}submit_save_redir'.format(save_prefix))
        ...
        self.browser.find_element(By.LINK_TEXT, 'Manage calculations').click()
        ...
        self.browser.find_element(By.LINK_TEXT, 'View calculation').click()
    ...
    def view_proposal_by_code(self, facility_code, proposal_code):
        self.browser.get(
            '{}{}/proposal_by_code'.format(self.base_url, facility_code))

        self.browser.find_element(By.NAME, 'code').send_keys(proposal_code)

        self.browser.find_element(By.NAME, 'submit').click()

        self.assertIn(
            '<li>{}</li>'.format(proposal_code),
            self.browser.page_source)
    ...
    def accept_invitation(self, user_name='invitee', screenshot_path=None):
        ...
        self.browser.find_element(
            By.LINK_TEXT, 'Enter an invitation code').click()
        ...
        self.browser.find_element(By.NAME, 'submit_accept').click()
    ...
    def remove_self(self):
        ...
        self.browser.find_element(
            By.LINK_TEXT, 'Remove yourself from this proposal').click()
    ...
    def manage_account(self):
        ...
        # Change password.
        self.browser.find_element(By.LINK_TEXT, 'Change password').click()

        self.browser.find_element(By.NAME, 'password').send_keys('password')
        self.browser.find_element(By.NAME, 'password_new').send_keys(
            'new-pass')
        self.browser.find_element(By.NAME, 'password_check').send_keys(
            'new-pass')
        ...
        # Change user name.
        self.browser.find_element(By.LINK_TEXT, 'Change user name').click()

        user_name_box = self.browser.find_element(By.NAME, 'user_name')
        user_name_box.clear()
        user_name_box.send_keys('newusername')
        self.browser.find_element(By.NAME, 'password').send_keys('new-pass')
        ...
        # Edit profile.
        self.browser.find_element(By.LINK_TEXT, 'Edit profile').click()
        ...
        self.browser.find_element(By.ID, 'add_email').click()

        self.browser.find_element(By.NAME, 'email_new_1').send_keys(email_new)
        self.browser.find_element(By.NAME, 'submit').click()
        ...
        # Change institution.
        self.browser.find_element(By.LINK_TEXT, 'Change institution').click()
        ...
        self.browser.find_element(By.NAME, 'submit_edit').click()
        ...
        # Institution list.
        self.browser.find_element(By.LINK_TEXT, 'Institutions').click()
        ...
        self.browser.find_element(By.LINK_TEXT, 'User Directory').click()
    ...
    def administer_facility(self, facility_code, semester_name, queue_name):
        ...
        close_date = self.browser.find_element(By.NAME, 'close_date')
        close_date.clear()
        close_date.send_keys(current_year + '-01-01')

        close_time = self.browser.find_element(By.NAME, 'close_time')
        close_time.clear()
        ...
        self.browser.find_element(By.ID, 'member_inst_ed_2').click()
        ...
        # And change the frozen institution back for use in later tests.
        self.browser.find_element(By.ID, 'member_inst_ed_2').click()
        ...
        self.browser.find_element(By.ID, 'alter_state_link').click()
        ...
        self.browser.get(admin_menu_url)
        self.browser.find_element(By.LINK_TEXT, 'Semesters').click()
        self.browser.find_element(By.LINK_TEXT, semester_name).click()
        ...
        for (group_name, group_abbr, group_members) in (
                ...
                ('Technical assessors', 'tech', (
                    'Example Technical Assessor', None))):
            self.browser.get(admin_queue_url)
            self.browser.find_element(By.LINK_TEXT, group_name).click()
    ...
    def set_up_review(self, facility_code):
        ...
        self.browser.find_element(By.LINK_TEXT, 'Administrative menu').click()
        self.browser.find_element(By.LINK_TEXT, 'Calls').click()
        self.browser.find_element(By.LINK_TEXT, 'Review process').click()

        self._save_screenshot(self.admin_image_root, 'review_process')

        # Set review deadlines.
        self.browser.find_element(
            By.LINK_TEXT, 'Edit review deadlines').click()

        self.browser.find_element(By.NAME, 'date_date_2').send_keys('2020-01-01')
        self.browser.find_element(By.NAME, 'date_time_2').send_keys('00:00')
        ...
        self.browser.find_element(By.LINK_TEXT, 'Add external reviewer').click()

        self.browser.find_element(By.NAME, 'name').send_keys('Invited Reviewer')
        self.browser.find_element(By.NAME, 'email').send_keys(
        ...
        self.browser.find_element(
            By.XPATH, '//a[@title="Re-send invitation"]').click()
        ...
        self.assertIn(
            'has been re-invited to register.',
            self.browser.page_source)

        self.browser.find_element(
            By.XPATH, '//a[@title="Send reminder"]').click()
        ...
        self.browser.find_element(
            By.XPATH, '//a[@title="Add note"]').click()

        self.browser.find_element(By.NAME, 'note').send_keys(
            'Example note')

        self.browser.find_element(By.NAME, 'submit').click()

        self.assertIn(
            'The note for proposal',
            self.browser.page_source)

        # Technical reviewers page.
        self.browser.find_element(
            By.LINK_TEXT, 'Assign technical assessors').click()

        self.browser.find_elements(By.NAME, 'rev_{}_1'.format(
        ...
        self.browser.find_element(
            By.LINK_TEXT, 'Assign committee members').click()
        ...
        self.browser.find_element(
            By.LINK_TEXT, 'Notify technical assessors').click()
    ...
    def set_up_peer_review(self, facility_code):
        self.browser.get(self.base_url + facility_code)
        self.browser.find_element(By.LINK_TEXT, 'take admin').click()
        self.browser.find_element(By.LINK_TEXT, 'rapid turnaround').click()

        # Set review deadlines.
        self.browser.find_element(
            By.LINK_TEXT, 'Edit review deadlines').click()

        self.browser.find_element(By.NAME, 'date_date_7').send_keys('2020-01-01')
        ...
        self.browser.find_element(By.LINK_TEXT, 'Assign reviewers').click()
        self.browser.find_element(By.LINK_TEXT, 'Assign peer reviewers').click()

        for checkbox in self.browser.find_elements(
    ...
    def enter_technical_assessment(self):
        ...
        self.browser.find_element(By.LINK_TEXT, 'Your reviews').click()

        self.browser.find_element(By.LINK_TEXT, 'Technical').click()
        ...
        Select(
            self.browser.find_element(By.NAME, 'assessment')
    ...
    def enter_review(self):
        ...
        self.browser.find_element(By.NAME, 'jcmt_review_aims').send_keys(
            'The aims of this proposal ...')

        self.browser.find_element(By.NAME, 'jcmt_review_analysis').send_keys(
            'The proposed analysis ...')

        self.browser.find_element(
            By.NAME, 'jcmt_review_difficulties').send_keys(
            'Difficulties with this proposal are ...')

        Select(
            self.browser.find_element(By.NAME, 'jcmt_rating_justification')
        ).select_by_visible_text('Convincing and well described')

        self.browser.find_element(By.NAME, 'jcmt_review_details').send_keys(
            'The technical details in this program ...')

        self.browser.find_element(By.NAME, 'jcmt_review_obj_inst').send_keys(
            'The target objects and instrumentation ...')

        self.browser.find_element(By.NAME, 'jcmt_review_telescope').send_keys(
            'The choice of telescope for this proposal is ...')

        Select(
            self.browser.find_element(By.NAME, 'jcmt_rating_technical')
        ).select_by_visible_text('Correct and well described')

        Select(
            self.browser.find_element(By.NAME, 'jcmt_rating_urgency')
        ).select_by_visible_text('Timely and competitive: must be done now')

        self.browser.find_element(By.NAME, 'text').send_keys(
            'My opinion of this proposal is...')
        self.browser.find_element(By.NAME, 'rating').send_keys('50')
    ...
    def enter_cttee_review(
        ...
        self.browser.find_element(By.LINK_TEXT, role_name).click()

        # Fill in the review.
        self.browser.find_element(By.NAME, 'text').send_keys(
            'My {} review is as follows...'.format(role_name))

        self.browser.find_element(By.NAME, 'rating').send_keys(rating)

        Select(
            self.browser.find_element(By.NAME, 'jcmt_expertise')
    ...
    def enter_peer_review(self):
        ...
        self.browser.find_element(By.LINK_TEXT, 'Peer').click()
    ...
    def accept_review(self, screenshot_prefix=None):
        Select(
            self.browser.find_element(By.NAME, 'accepted')
        ).select_by_value('1')
    ...
    def view_proposal_reviews(self, facility_code):
        ...
        self.browser.find_element(By.NAME, 'weight_1').send_keys('40')
        self.browser.find_element(By.NAME, 'weight_2').send_keys('40')
        ...
        self.browser.find_element(
            By.LINK_TEXT, 'Edit time available').click()

        self.browser.find_element(By.NAME, 'available_1').send_keys('150')
        self.browser.find_element(By.NAME, 'available_2').send_keys('250')
        self.browser.find_element(By.NAME, 'available_3').send_keys('250')
        self.browser.find_element(By.NAME, 'available_4').send_keys('200')
        self.browser.find_element(By.NAME, 'available_5').send_keys('150')
        ...
        self.browser.find_element(
            By.LINK_TEXT, 'Advance to final review phase').click()
        ...
        Select(
            self.browser.find_element(By.NAME, 'decision_accept')
        ).select_by_visible_text('Accept proposal')

        time_field = self.browser.find_element(By.NAME, 'time_new_1')
        time_field.clear()
        time_field.send_keys('2')
        time_field = self.browser.find_element(By.NAME, 'time_new_2')
        time_field.clear()
        ...
        self.assertIn(
            '<h1>Allocation Details:',
            self.browser.page_source)

        # Look at the call clashes (none since only one proposal)
        self.browser.get(review_process_url)
        self.browser.find_element(
            By.LINK_TEXT, 'Search for clashes').click()
        ...
        self.browser.get(review_process_url)
        self.browser.find_element(
            By.LINK_TEXT, 'Approve feedback reports').click()
    ...
    def change_institution(
            self, institution_name, institution_country):
        self.browser.find_element(By.ID, 'user_profile_link').click()
    ...
    def administer_site(self):
        self.browser.get(self.base_url)
        self.browser.find_element(By.LINK_TEXT, 'Site administration').click()
        admin_menu_url = self.browser.current_url

        self._save_screenshot(self.admin_image_root, 'site_admin_menu')

        self.browser.find_element(By.LINK_TEXT, 'Email messages').click()
        self._save_screenshot(self.admin_image_root, 'message_list')

        self.browser.find_element(By.PARTIAL_LINK_TEXT, 'submitted').click()
        ...
        ).select_by_visible_text('Discarded')

        self.browser.find_element(By.NAME, 'submit').click()

        self.assertIn(
            'The state has been set to discarded.',
            self.browser.page_source)
        ...
        self.browser.find_element(By.LINK_TEXT, 'Messages').click()
        ...
        self.browser.get(admin_menu_url)
        self.browser.find_element(
            By.LINK_TEXT, 'Approve institution edits').click()
        self._save_screenshot(self.admin_image_root, 'approve_inst_edit')

        self.browser.get(admin_menu_url)
        self.browser.find_element(
            By.LINK_TEXT, 'View processing status').click()
        ...
        # Try disabling and enabling the account "noprofile".
        self.browser.find_element(By.LINK_TEXT, 'noprofile').click()
        self.browser.find_element(
            By.LINK_TEXT, 'Disable account').click()

        self.assertIn(
            'Are you sure you wish to disable this account?',
            self.browser.page_source)
        ...
        self.browser.find_element(
            By.LINK_TEXT, 'Enable account').click()

        self.assertIn(
            'Are you sure you wish to enable this account?',
            self.browser.page_source)
        ...
        self.browser.get(admin_menu_url)
        self.browser.find_element(By.LINK_TEXT, 'User log in sessions').click()

        self.browser.find_element(
            By.LINK_TEXT, 'Log out all').click()
        ...
        self.browser.find_element(
            By.LINK_TEXT, 'Subsume duplicate profile').click()

        self._select_value_selectize(
            'duplicate_id',
            text='Another Person, Another Institution, United States')
        ...
        self.assertIn(
            '<h1>Institution Edit Log: Test Institution</h1>',
            self.browser.page_source)
        ...
        self.browser.find_element(By.LINK_TEXT, 'View frozen members').click()

        self.assertIn(
            '<h1>Frozen Members: Test Institution</h1>',
            self.browser.page_source)

        self.browser.back()

        self.browser.find_element(
            By.LINK_TEXT, 'Subsume duplicate record').click()
        ...
        self.browser.find_element(
            By.LINK_TEXT, 'Institutions').click()

        self.browser.find_element(
            By.LINK_TEXT, 'Temporary Institution').click()

        self.browser.find_element(
            By.LINK_TEXT, 'Delete institution').click()
        ...
        self.browser.get(admin_menu_url)
        self.browser.find_element(By.LINK_TEXT, 'Profile viewers').click()
        ...
        self.assertIn(
            'Would you like to re-send an invitation to site group',
            self.browser.page_source)

        self.browser.find_element(By.NAME, 'submit_confirm').click()

        self.assertIn(
            'has been re-invited to the site group',
            self.browser.page_source)

    def view_user_directory(self):
        self.browser.get(self.base_url + 'person')

        user_directory_url = self.browser.current_url

        self.browser.find_element(By.LINK_TEXT, 'take admin').click()

        Select(
            self.browser.find_element(By.NAME, 'registered')
        ).select_by_visible_text('Any status')

        self.browser.find_element(By.ID, 'submit_filter').click()

        self._save_screenshot(self.admin_image_root, 'person_list')

        self.browser.find_element(
            By.LINK_TEXT, 'Invited Member').click()
        ...
        self.browser.find_element(
            By.LINK_TEXT, 'View proposal list').click()

        self.assertIn(
            '<h1>Invited Member: Proposals</h1>',
            self.browser.page_source)

        self.browser.back()

        self.browser.find_element(
            By.LINK_TEXT, 'View review list').click()

        self.assertIn(
            '<h1>Invited Member: Reviews</h1>',
            self.browser.page_source)

        self.browser.back()

        self.browser.find_element(
            By.LINK_TEXT, 'Invite to register').click()

        self._save_screenshot(self.admin_image_root, 'person_invite')

        self.browser.find_element(By.NAME, 'submit_cancel').click()

        self.browser.get(user_directory_url)

        self.browser.find_element(
            By.LINK_TEXT, 'Example Person').click()

        self.browser.find_element(
            By.LINK_TEXT, 'Person action log').click()

        self.assertIn(
            '<h1>Example Person: Action Log</h1>',
            self.browser.page_source)
    ...
    def copy_proposal(
        ...
        if call_type_name is None:
            ...
            self.browser.find_element(By.LINK_TEXT, 'Other calls for proposals').click()

            self.browser.find_element(By.LINK_TEXT, call_type_name).click()

        queue_link = self.browser.find_element(
            By.PARTIAL_LINK_TEXT, 'Create a proposal for the PI Science Queue')
    ...
    def try_jcmt_tools(self):
        ...
        self.browser.find_element(By.NAME, 'x').send_keys('12:34:56')
        self.browser.find_element(By.NAME, 'y').send_keys('7:08:09')
        self.browser.find_element(By.NAME, 'submit_calc').click()
    ...
    def view_contact_page(self):
        ...
        self.browser.find_element(
            By.LINK_TEXT, 'Contact us').click()

        self.assertIn(
            '<h1>Contact Us</h1>',
            self.browser.page_source)

    def view_help_pages(self):
        self.browser.get(self.base_url)

        self.browser.find_element(
            By.LINK_TEXT, 'Help and information').click()

        self.browser.find_element(
            By.PARTIAL_LINK_TEXT, 'Proposal Author').click()
        self.browser.find_element(
            By.PARTIAL_LINK_TEXT, 'Creating an Account').click()
        ...
        self.browser.find_element(
            By.PARTIAL_LINK_TEXT, 'Reviewer').click()
        self.browser.find_element(
            By.PARTIAL_LINK_TEXT, 'Receiving an Invitation').click()

        self.assertIn(
            '<h1>Receiving an Invitation to Review a Proposal</h1>',
            self.browser.page_source)
        ...
        self.browser.find_element(
            By.PARTIAL_LINK_TEXT, 'Administrator').click()
        self.browser.find_element(
            By.PARTIAL_LINK_TEXT, 'User Accounts').click()
        ...
        self.browser.find_element(
            By.PARTIAL_LINK_TEXT, 'About this System').click()
    ...
    def clear_invitations(self):
        with self.db._transaction() as conn:
            conn.execute(invitation.delete())
