...
class WebAppAuthTestCase(WebAppTestCase):
    ...
    def test_view_auth(self):
        ...
        for test_case in [
                ...
                (1,  person_a1e,   False, proposal_a1, 'eeevvvvvv', 'ooooovvoo', 'ooooooooo'),
                (2,  person_a2e,   False, proposal_a2, 'eeevvvvvv', 'ooooovvoo', 'ooooooooo'),
                (3,  person_a2m,   False, proposal_a2, 'vvvvvvvvv', 'ooooovvoo', 'ooooooooo'),
                (4,  person_a2u,   False, proposal_a2, 'vvvvvvvvv', 'ooooovvoo', 'ooooooooo'),
                (5,  person_a2u,   False, proposal_a2, 'vvvvvvvvv', 'ooooovvoo', 'ooooooooo'),
                # No member access to other proposals.
                (10, person_a1e,   False, proposal_a2, 'ooooooooo', 'ooooooooo', 'ooooooooo'),
                (11, person_a1u,   False, proposal_a2, 'ooooooooo', 'ooooooooo', 'ooooooooo'),
                (12, person_a2e,   False, proposal_a1, 'ooooooooo', 'ooooooooo', 'ooooooooo'),
                (13, person_a2m,   False, proposal_a1, 'ooooooooo', 'ooooooooo', 'ooooooooo'),
                (14, person_a2u,   False, proposal_a1, 'ooooooooo', 'ooooooooo', 'ooooooooo'),
                (15, person_a2p,   False, proposal_a1, 'ooooooooo', 'ooooooooo', 'ooooooooo'),
                # Admin has access but only when is_admin is set.
                (20, person_admin, False, proposal_a1, 'ooooooooo', 'ooooooooo', 'ooooooooo'),
                (21, person_admin, False, proposal_a2, 'ooooooooo', 'ooooooooo', 'ooooooooo'),
                (22, person_admin, True,  proposal_a1, 'vvvvvvvvv', 'ooooovvoo', 'oooowoooo'),
                (23, person_admin, True,  proposal_a2, 'vvvvvvvvv', 'ooooovvoo', 'oooowoooo'),
                # Review coordinators can see all proposals.
                (30, person_a_rc,  False, proposal_a1, 'oovvvvvoo', 'ooooooooo', 'oooowoooo'),
                (31, person_a_rc,  False, proposal_a2, 'oovvvvvoo', 'ooooooooo', 'oooowoooo'),
                (32, person_a_rc,  False, proposal_b1, 'ooooooooo', 'ooooooooo', 'ooooooooo'),
                (33, person_a_rc,  False, proposal_b2, 'ooooooooo', 'ooooooooo', 'ooooooooo'),
                (34, person_b_rc,  False, proposal_a1, 'ooooooooo', 'ooooooooo', 'ooooooooo'),
                (35, person_b_rc,  False, proposal_a2, 'ooooooooo', 'ooooooooo', 'ooooooooo'),
                (36, person_b_rc,  False, proposal_b1, 'oovvvvvoo', 'ooooooooo', 'oooowoooo'),
                (37, person_b_rc,  False, proposal_b2, 'oovvvvvoo', 'ooooooooo', 'oooowoooo'),
                # Committee members can see all proposals.
                (40, person_a1rc1, False, proposal_a1, 'oovvvvvoo', 'ooooooooo', 'ooooooooo'),
                (41, person_a1rc1, False, proposal_a2, 'oovvvvvoo', 'ooooooooo', 'ooooooooo'),
                (42, person_a1rc1, False, proposal_b1, 'ooooooooo', 'ooooooooo', 'ooooooooo'),
                (43, person_a1rc1, False, proposal_b2, 'ooooooooo', 'ooooooooo', 'ooooooooo'),
                (44, person_a1rc2, False, proposal_a1, 'oovvvvvoo', 'ooooooooo', 'ooooooooo'),
                (45, person_a1rc2, False, proposal_a2, 'oovvvvvoo', 'ooooooooo', 'ooooooooo'),
                (46, person_a1rc2, False, proposal_b1, 'ooooooooo', 'ooooooooo', 'ooooooooo'),
                (47, person_a1rc2, False, proposal_b2, 'ooooooooo', 'ooooooooo', 'ooooooooo'),
                # Technical reviewers can only see their assigned proposals.
                (50, person_a1rt,  False, proposal_a1, 'ooovvoooo', 'ooooooooo', 'ooooooooo'),
                (51, person_a1rt,  False, proposal_a2, 'ooooooooo', 'ooooooooo', 'ooooooooo'),
                (52, person_a1rt,  False, proposal_b1, 'ooooooooo', 'ooooooooo', 'ooooooooo'),
                (53, person_a1rt,  False, proposal_b2, 'ooooooooo', 'ooooooooo', 'ooooooooo'),
                # External reviewers can only see their assigned proposals.
                (60, person_a1re,  False, proposal_a1, 'ooovooooo', 'ooooooooo', 'ooooooooo'),
                (61, person_a1re,  False, proposal_a2, 'ooooooooo', 'ooooooooo', 'ooooooooo'),
                (62, person_a1re,  False, proposal_b1, 'ooooooooo', 'ooooooooo', 'ooooooooo'),
                (63, person_a1re,  False, proposal_b2, 'ooooooooo', 'ooooooooo', 'ooooooooo'),
                (64, person_a1reu, False, proposal_a1, 'ooovooooo', 'ooooooooo', 'ooooooooo'),
                (65, person_a1reu, False, proposal_a2, 'ooooooooo', 'ooooooooo', 'ooooooooo'),
                (66, person_b1reu, False, proposal_b1, 'ooovooooo', 'ooooooooo', 'ooooooooo'),
                (67, person_b1reu, False, proposal_b2, 'ooooooooo', 'ooooooooo', 'ooooooooo'),
                # Peer reviewers.
                (68, person_a1rpn, False, proposal_a1, 'ooorooooo', 'ooooooooo', 'ooooooooo'),
                (69, person_a1rpa, False, proposal_a1, 'ooovooooo', 'ooooooooo', 'ooooooooo'),
                (70, person_a1rpr, False, proposal_a1, 'ooooooooo', 'ooooooooo', 'ooooooooo'),
                # Viewers: view access for proposals and feedback in same queue.
                (71, person_a_v,   False, proposal_a1, 'oovvvvvoo', 'ooooovvoo', 'ooooooooo'),
                (72, person_a_v,   False, proposal_b1, 'ooooooooo', 'ooooooooo', 'ooooooooo'),
                ]:
        ...
        for test_case in [
                # No general access.
                (1,  person_a1rt,  False, reviewer_a1re,  'ooooooooo'),
                (2,  person_a1rt,  False, reviewer_a1rc1, 'ooooooooo'),
                (3,  person_a1rt,  False, reviewer_a1rc2, 'ooooooooo'),
                (4,  person_a1re,  False, reviewer_a1rt,  'ooooooooo'),
                (5,  person_a1re,  False, reviewer_a1rc1, 'ooooooooo'),
                (6,  person_a1re,  False, reviewer_a1rc2, 'ooooooooo'),
                # Ensure no proposal members have access.
                (10, person_a1e,   False, reviewer_a1re,  'ooooooooo'),
                (11, person_b1e,   False, reviewer_b1reu, 'ooooooooo'),
                (12, person_a1x1,  False, reviewer_a1x1,  'ooooooooo'),
                (13, person_a1x2,  False, reviewer_a1re,  'ooooooooo'),
                (14, person_a1x3,  False, reviewer_a1re,  'ooooooooo'),
                (15, person_a1x4,  True,  reviewer_a1re,  'ooooooooo'),
                # Admin has access but only when is_admin is set.
                (20, person_admin, False, reviewer_a1rt,  'ooooooooo'),
                (21, person_admin, False, reviewer_a1re,  'ooooooooo'),
                (22, person_admin, False, reviewer_a1rc1, 'ooooooooo'),
                (23, person_admin, False, reviewer_a1rc2, 'ooooooooo'),
                (24, person_admin, False, reviewer_b1reu, 'ooooooooo'),
                (25, person_admin, True,  reviewer_a1rt,  'vvvEEVVvv'),
                (26, person_admin, True,  reviewer_a1re,  'vvvEVVVvv'),
                (27, person_admin, True,  reviewer_a1rc1, 'vvveEVVvv'),
                (28, person_admin, True,  reviewer_a1rc2, 'vvveEVVvv'),
                (29, person_admin, True,  reviewer_b1reu, 'vvvEVVVvv'),
                # Admin-like access for review coordinators.
                (30, person_a_rc,  False, reviewer_a1rt,  'vvvEEVVvv'),
                (31, person_a_rc,  False, reviewer_a1re,  'vvvEVVVvv'),
                (32, person_a_rc,  False, reviewer_a1rc1, 'vvveEVVvv'),
                (33, person_a_rc,  False, reviewer_a1rc2, 'vvveEVVvv'),
                (34, person_b_rc,  False, reviewer_a1rt,  'ooooooooo'),
                (35, person_b_rc,  False, reviewer_a1re,  'ooooooooo'),
                (36, person_b_rc,  False, reviewer_a1rc1, 'ooooooooo'),
                (37, person_b_rc,  False, reviewer_a1rc2, 'ooooooooo'),
                (38, person_a_rc,  False, reviewer_b1reu, 'ooooooooo'),
                (39, person_b_rc,  False, reviewer_b1reu, 'vvvEVVVvv'),
                # View access for committee members.
                (40, person_a1rc1, False, reviewer_a1rt,  'vvvVVVVvv'),
                (41, person_a1rc1, False, reviewer_a1re,  'vvvVVVVvv'),
                (42, person_a1rc1, False, reviewer_a1rc2, 'vvvvVVVvv'),
                (43, person_a1rc1, False, reviewer_b1reu, 'ooooooooo'),
                (44, person_a1rc2, False, reviewer_a1rt,  'vvvVVVVvv'),
                (45, person_a1rc2, False, reviewer_a1re,  'vvvVVVVvv'),
                (46, person_a1rc2, False, reviewer_a1rc1, 'vvvvVVVvv'),
                (47, person_a1rc2, False, reviewer_b1reu, 'ooooooooo'),
                # Allow reviewers access to their own reviews.
                (50, person_a1rt,  False, reviewer_a1rt,  'oooEEoooo'),
                (51, person_a1re,  False, reviewer_a1re,  'oooEooooo'),
                (52, person_a1reu, False, reviewer_a1reu, 'oooEooooo'),
                (54, person_b1reu, False, reviewer_b1reu, 'oooEooooo'),
                (55, person_a1rc1, False, reviewer_a1rc1, 'vvvEEVVvv'),
                (56, person_a1rc2, False, reviewer_a1rc2, 'vvvEEVVvv'),
                (57, person_a1rf,  False, reviewer_a1rf,  'vvvVEVVvv'),
                (58, person_b1rf,  False, reviewer_b1rf,  'vvvVEVVvv'),
                # Committee member special case access to feedback review.
                (60, person_a1rc1, False, reviewer_a1rf,  'vvvVEVVvv'),
                (61, person_a1rc2, False, reviewer_a1rf,  'vvvVEVVvv'),
                (62, person_a1rc1, False, reviewer_b1rf,  'ooooooooo'),
                (63, person_a1rc2, False, reviewer_b1rf,  'ooooooooo'),
                # Peer reviewers.
                (64, person_a1rpn, False, reviewer_a1rpn, 'ooorooooo'),
                (65, person_a1rpa, False, reviewer_a1rpa, 'oooEooooo'),
                (66, person_a1rpr, False, reviewer_a1rpr, 'ooooooooo'),
                # Special case: proposal member can access feedback.
                (67, person_a1x3,  False, reviewer_a1rf,  'vvvVEVVvv'),
                # Viewers: view access for reviews in same queue.
                (68, person_a_v,   False, reviewer_a1rt,  'vvvVVVVvv'),
                (69, person_a_v,   False, reviewer_b1reu, 'ooooooooo'),
                ]:
